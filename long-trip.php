...
<head>
    ...
    <link rel="stylesheet" href="css/long-trip.css?v=<?php echo time(); ?>">
</head>
<body>
    ...
    if(isset($_POST['submit'])){
        ...
        $str=trim($str);
        $result=$mysqli->query(" SELECT * FROM longtrip where location like ('%$str%')") ;
   ...
   ?>
    ...
    text-align:center;" >
        ...
        <p style="margin:20px;"><?php echo "INR " . $product['Price']."/week"?></p>
        <?php echo "<a class='btn2 'style='border-radius: 20px;background-color:#F0C929 !important;
        color: black; padding:10px 20px;text-decoration:none;' href='long-trip-details.php?id=".$product['id']."' role='button'>". "View" . "</a>" ?>
