...
<body>
    <nav class="topnav navbar navbar-expand-md bg-dark navbar-light">
        <div class="container">
        <a class="navbar-brand active" href="index.php">Car E Rental</a>
        <ul class="navbar-nav">
            <li class="nav-item"> 
    ...
    <div id="slider">
        ...
        <div class="text"><h2><Strong>START YOUR JOURNEY HERE</Strong></h2>
            <a class="btn btn-dark btn1" href="rentals.php" role="button">View Plans</a>
        </div>
  ...
  <div class="row second"style="margin-right:0;margin-left:0;" >
    <div class="col-sm-4">
        <div class="card1">
    ...
    <div class="card">
      ...
      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionE" >
        <div class="card-body">
            ...
            Firstly, you will have to <a href ="login.php" >create an account</a> and decide the plan you want to opt for.
            We recommend using 
            the <a href="rentals.php">rental plans</a> if you are a first time user. The <a href="subscription-main.php">subscription plans</a> are great if you are a frequent customer.
    ...
    <div class="card">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionE" >
        <div class="card-body">
            ...
            Firstly, you will have to create an account as a owner and fill in the necessary information.
